...
//    public static final String CACHE_WX_SESSION = "CACHE_WX_SESSION";
    ...
    public static final String CACHE_PRODUCT_SKU = "CACHE_PRODUCT_SPU"; //单品SKU 按照商家缓存
    public static final String CACHE_PRODUCT_SKU_ATTR = "CACHE_PRODUCT_SKU_ATTR"; //单品SKU属性 按照商品分类缓存
