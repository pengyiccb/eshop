...
CREATE TABLE `e_shop_product` (
  ...
  `attrs_sp_el` varchar(255) DEFAULT '' COMMENT '属性列表',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2018-06-16  0:33:13
