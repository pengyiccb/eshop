...
public class PaymentController {
    ...
    public R<ApiResponsePrepayOrder> getPrepayOrderInfo(@RequestParam Integer tradeNo, HttpServletRequest request) {
    ...
    @RequestMapping(value = "/notifyFromWeChat", method = RequestMethod.POST)
