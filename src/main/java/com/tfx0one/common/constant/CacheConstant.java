...
//    public static final String CACHE_PRODUCT_SKU_ATTR = "CACHE_PRODUCT_SKU_ATTR";
    ...
    public static final String CACHE_PRODUCT_SKU_ATTR_BY_USER_ID = "CACHE_PRODUCT_SKU_ATTR_BY_USER_ID"; //单品SKU属性 按照 用户ID 缓存
    ...
    //缓存菜单
    public static final String CACHE_ROLE_MENU_BY_ID = "CACHE_ROLE_MENU_BY_ID"; //促销活动 按照 ID 缓存
    public static final String CACHE_ROLE_MENU_BY_ROLE_ID = "CACHE_ROLE_MENU_BY_ROLE_ID"; //促销活动 按照 ID 缓存
